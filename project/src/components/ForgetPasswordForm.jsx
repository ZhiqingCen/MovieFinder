...
// form to let user forget their password
function ForgetPasswordForm ({ submit }) {
  ...
  return (<>
    ...
    >
      ...
      />
      <br />
      <Button variant='outlined' onClick={() => submit(email, verificationCode, password, password2)}>Submit</Button>
    </Box>
  </>);
}
